<template>
    <div class="documents">
        ...
        <div class="documents__list p-80 container">
            ...
            <router-link :to="{ name: 'main.legalinformation.oferta.dealer' }" class="documents__list--items">
                <div class="title">
                    <span>Оферта</span>
            ...
            <router-link :to="{ name: 'main.legalinformation.termofuse.dealer' }" class="documents__list--items"><div class="title">
            ...
            <router-link :to="{ name: 'main.legalinformation.personaldata.dealer' }" class="documents__list--items"><div class="title">
            ...
            <router-link :to="{ name: 'main.legalinformation.privacypolicy.dealer' }" class="documents__list--items">
