...
<template>
    <div class="auth">
        <div class="auth__userInfo container p-80">
            ...
            <div class="user__ads">
                <div class="title"><span>Мои объявления</span> <span @click="$router.push({ name: 'cabinet.add.auksion'})" class="btn btn-primary">Добавить</span> </div>
                        ...
                        <div class="aukstion__block--items" v-for="car in cars" :key="car.id">
                            ...
                            <div class="actions">
                                ...
                                <div class="action__price--bet">
                                    <router-link :to="{ name: 'main.auksion.inside', params: { id: car.auksion_id } }" class="btn btn-primary">Посмотреть в каталоге</router-link>
                                </div>
                            </div>
