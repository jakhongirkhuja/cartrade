...
<template>
    <div class="auth">
        <div class="auth__userInfo container p-80">
            <div class="user row">
                ...
                <div class="info fx-1">
                    <div class="name row space_between">{{ familyName }} {{ name }}
                        <router-link :to="{ name: 'cabinet.list.user.admin' }"
                            class="list_user">Пользователи</router-link>
                    </div>
                    <div class="body ">
            ...
            <div class="user__ads">
                <div class="title"><span>Объявления</span> <span @click="$router.push({ name: 'cabinet.add.auksion' })"
                        class="btn btn-primary">Добавить</span> </div>
                    ...
                    <div class="aukstion__block container">
                        <template v-if="cars.length > 0">
                            <div class="aukstion__block--items" v-for="car in cars" :key="car.id">
                                ...
                                <div class="info">
                                    <h2 class="info__title"><a href="#">{{ car.car_mark.name }} {{ car.car_model.name }}
                                            -
                                            {{ car.year }}</a></h2>
                                ...
                                <div class="actions">
                                    ...
                                    <div class="action__price--bet">
                                        <router-link :to="{ name: 'cabinet.edit.auksion', params: { id: car.id } }"
                                            class="btn btn-primary">Редактировать</router-link>
                    ...
                    <div class="reviews__each" v-for="(slide, index) in slides" :key="index">
                        <div class="author fx">
                            ...
                            <div class="info">
                                ...
                                <div class="stars">
                                    <svg v-for="n in slide.stars" :key="n" width="15" height="14" viewBox="0 0 15 14"
                        ...
                        <div class="body">
                            ...
                            <div class="status" style="margin-top: 10px;">
                                <label :class="{ 'checked': slide.status }">
                                    Статус:
                                    <input type="checkbox" v-model="slide.status"
                                        @change="handleCheckReview(slide.id)" />
                                    <span class="custom-checkbox"></span>
                        ...
                        <div class="actions">
                            ...
                            <div class="delete text-center" @click="handleDeleteReview(slide.id)"
                                style="margin-top: 20px;">Удалить
                            </div>
