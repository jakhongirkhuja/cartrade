                    ...
                    <template v-if="cars.length>0">
                        <template v-for="car in cars" :key="car.id">
                            <div class="aukstion__block--items" v-if="car.car" >
                                ...
                                <div class="info">
                                    <h2 class="info__title"><a href="#">{{car.car.car_mark.name}} {{car.car.car_model.name}} - {{car.car.ear}}</a></h2>
                                    ...
                                    <div class="row"><p class="paying">Оплатить</p></div>
                                </div>
                                <div class="actions">
                                    ...
                                    <div class="action__price--bet">
                                        <div class="btn btn-primary-outline"  v-if="!car.sold">
                                            <CountdownTimer 
                                            :timeStart="car.time_start"
                                            :timeEnd="car.time_end"
                                             />
                                            </div>
                                            <span class="notbutton" v-else-if="car.sold_user_id==user_id">Успешно!</span>
