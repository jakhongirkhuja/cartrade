<template>
    <div>
        <div class="headerMenu container fx">
            <ul class="fx" style="display: none!important;">
                ...
                <li class="hover">
                    ...
                    <ul class="inside">
                        <li><router-link :to="{ name: 'main.documents.dealer' }">Необходимые документы</router-link>
                        </li>
                        <li><router-link :to="{ name: 'main.legalinformation.dealer' }">Юридическая
                                информация</router-link></li>
                    </ul>
                </li>
